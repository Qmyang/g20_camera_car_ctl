...
HD_PWD='F:/image_filter/image_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_filter_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source image_filter_top.tcl -notrace
